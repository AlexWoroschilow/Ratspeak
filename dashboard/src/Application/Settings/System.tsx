...
export class System extends React.Component<SystemProps, SystemState> {
            ...
            <section className="settings-detail-pane" aria-labelledby="settings-detail-title">
                <div className="settings-mobile-detail-bar">
                    ...
                    <div className="settings-mobile-detail-copy">
                        ...
                        <h2 id="settings-mobile-detail-title">System</h2>
                    </div>
                </div>
                <div className="settings-detail-header">
                    <div>
                        <span className="settings-detail-eyebrow">Ratspeak</span>
                        <h2 id="settings-detail-title">System</h2>
                    </div>
                    <p id="settings-detail-desc">Developer and reset controls.</p>
                </div>
                <div className="settings-page-inner settings-detail-panels">
                    ...
                    <div className="panel settings-panel settings-panel-selected" id="panel-settings-system" aria-hidden="false">
