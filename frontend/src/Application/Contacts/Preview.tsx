...
export default class Preview extends React.PureComponent<PreviewProps> {
    ...
    render() {
        const {peer, onMessage, onCall, onRemoveContact, onBlock} = this.props;
        ...
        return (
            <div className="peers-detail-content">
                ...
                <div className="peers-detail-actions entity-action-grid">
                    <button className="nr-btn entity-action-btn" onClick={this.onCall.bind(this, peer)}>
                    ...
                    <button className="nr-btn entity-action-btn" onClick={this.onMessage.bind(this, peer)}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                        </svg>
                        <span>Message</span>
                    </button>
                    <button className="nr-btn entity-action-btn" onClick={this.onRemove.bind(this, peer)}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
